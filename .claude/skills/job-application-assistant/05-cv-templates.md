...
**Source material for profile statements:** the two current base CVs in `documents/cv/` (`..._Backend_Software_Engineer_CV_v1`, `..._Cloud_Platform_Engineer_CV_v1`) — their profile paragraphs are already reflected in the templates below. The three older PDFs in `documents/cv/` (`cv_general.pdf`, `cv_mobile_grad.pdf`, `cv_grad_cloud.pdf`) are background reference only — do not pull profile statements or structure from them when generating a new targeted CV.
...
**For Cloud / DevOps / Platform Engineering roles:** *[Base CV: documents/cv/..._Cloud_Platform_Engineer_CV_v1, added 2026-08-31]*
> Cloud and platform-focused software engineer and Sabancı University Computer Science graduate completing an MSc in Advanced Computer Science at the University of Liverpool (dissertation submitted Sep 2026). Professional experience automating Hyper-V and VMware infrastructure with Python, PowerShell, and Ansible at a banking systems integrator, including LLM-assisted tooling to generate Ansible playbooks from infrastructure requirements. Built and deployed an Azure-hosted network-diagnostics platform collecting ~800K real-world measurements, provisioned with Bicep and Docker across Azure App Service, Azure Database for PostgreSQL/TimescaleDB, and Blob Storage, with Grafana for observability and systemd for resilient unattended operation. Holds Azure Fundamentals (AZ-900) certification with additional Linux and Windows systems experience in high-availability banking environments.

**For Mobile Development (Flutter) roles:**
> Software engineer and MSc Advanced Computer Science candidate (University of Liverpool, dissertation submitted Sep 2026) with three years of Flutter/Dart experience across internship, academic, and teaching contexts. Built a production mobile security tool integrating OpenCV and a CNN classifier for real-time document authenticity detection (94% precision); led a 5-person Agile team delivering a full-stack Flutter/Firebase e-commerce application; and mentored 40+ undergraduates in Flutter state management and widget architecture. Comfortable owning the full mobile stack from backend integration (Firebase, REST APIs, Supabase) through to on-device performance optimisation.

**For General Software Engineering / Backend roles:** *[Base CV: documents/cv/..._Backend_Software_Engineer_CV_v1, added 2026-08-31]*
> Software engineer and Sabancı University Computer Science graduate completing an MSc in Advanced Computer Science at the University of Liverpool (dissertation submitted Sep 2026). Built and deployed a Python/FastAPI/Azure network-diagnostics platform collecting ~800K real-world measurements, from a Raspberry Pi probe through to an Azure-hosted time-series database, alongside professional experience in infrastructure automation (Python/PowerShell VM inventory sync, LLM-assisted Ansible tooling) and additional C#/.NET development on IVAO's Aurora air-traffic-control client. Fluent in Python, C#, and C++; experienced with FastAPI, REST APIs, PostgreSQL/TimescaleDB, and Docker across cloud and on-device deployments.
